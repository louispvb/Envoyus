    ...
    <div className='setting-row'>
      ...
      <div className='setting-row-cntrl'>
        <Slider range
          ...
          defaultValue={[0, 1500]}
          min={0} max={1500}
          onChange={([l, u]) => props.setPriceFilter(l, u)} />
      </div>
    </div>
    <div className='setting-row'>
      ...
      <div className='setting-row-cntrl'>
        ...
        defaultValue={[0, 10]}
        min={0} max={10}
        onChange={([l, u]) => props.setConditionFilter(l, u)} />
      </div>
    </div>
    <div style={{}}>
      <div className='final-setting-row'>
        ...
        <div className='result-count'>{
          props.resultCount} Results · {props.cities[props.citySelection].cityName}
        </div>
      </div>
    </div>
  </div>
...
SearchSettings.propTypes = {
  setConditionFilter: T.func,
  setPriceFilter: T.func,
  citySelection: T.string,
        ...
        <div className='split-pane-horiz'>
          ...
          className='map-ctn'>
            ...
            listings={Array(50).fill(0).map(_ => ({
              ...
              long: longitude + (Math.random() / 20) - 0.03
            }))}
              currentLocation={{
                longitude,
                latitude,
